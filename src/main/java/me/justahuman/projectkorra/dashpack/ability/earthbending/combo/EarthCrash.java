...
public class EarthCrash extends EarthAbility implements ListenerAbility, PlayerLocationAbility, AddonComboAbility {
    ...
    static {
        ...
        try {
            ...
            DashPack.instance.getLogger().severe("Failed to find Ripple#initializeLocations method for EarthCrash ability.");
            e.printStackTrace();
        }
        INITIALIZE_LOCATIONS = handle;
    }

    private static final NamespacedKey RANGE_MODIFIER = DashPack.key("EarthCrashRange");
    private static final NamespacedKey DAMAGE_MODIFIER = DashPack.key("EarthCrashDamage");
    private static final NamespacedKey KNOCKBACK_MODIFIER = DashPack.key("EarthCrashKnockback");
